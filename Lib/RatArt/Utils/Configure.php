...
class Configure
{
     ...
     * @return mixed
     * @access public
     * @example Configure::read('database.blog') retourne la valeur du tableau correspondant dans $this->_data sous forme d'objet si possible
     */
